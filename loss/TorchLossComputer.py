...
class TorchLossComputer(object):
    """Compute complex absolute value for given k and N."""
    @staticmethod
    ...
    """Compute complex absolute values over a frequency range and apply an analog of Softmax."""
    @staticmethod
    ...
    """Compute cross-entropy loss based on the power spectrum."""
    @staticmethod
    ...
    """Compute power-spectrum cross-entropy loss with focal loss."""
    @staticmethod
    ...
    """Forward prediction from the power spectrum: returns index of the maximum."""
    @staticmethod
    ...
    """Compute KL-divergence and cross-entropy losses based on the power spectrum."""
    @staticmethod
